...
게임 시스템의 전반적인 장르, 컨텐츠, 연출 등을 기획하고, 각 데이터들의 테이블 구조를 작성하여 달곰냥냥마을의 디렉팅을 담당했습니다. 


게임의 흐름과 시스템을 구조적으로 정리하여 더 나은 경험을 제공할 수 있도록 기여하였습니다.

## 🧱 피그마 및 테이블

| 보러가기          | 설명                                                         |
| ----------------- | ------------------------------------------------------------ |
| [데이터 테이블](https://docs.google.com/spreadsheets/d/12YjEnFa-XuNGzXld111ps7JuTA7K0pwiZ8R5jOFWyA4/edit?usp=sharing)   | 게임 시스템에 필요한 **데이터와 구조**를 체계적으로 정리하여 효율적인 관리와 게임 밸런스를 구현 |
| [피그마](https://www.figma.com/board/fvuTQM2Nv0yTcjJ5QFd1sH/%EB%8B%AC%EA%B3%B0%EB%83%A5%EB%83%A5%EB%A7%88%EC%9D%84?node-id=0-1&t=aumgWRYlLFVWaePe-0) | 달곰냥냥 팀의 기획 피그마 |
...
## 6. 두투윈 활용 건물 텍스트 애니메이션, 버튼 애니메이션
...
## 9. Custom Editor (DebugManager, GameDataEditor, DataTransformer)
