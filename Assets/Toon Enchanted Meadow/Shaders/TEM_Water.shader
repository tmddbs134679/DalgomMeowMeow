	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 bakedGI886 = ASEIndirectDiffuse( input, WorldNormal );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float clampResult211 = clamp( distanceDepth146 , 0.0 , 1.0 );
				float4 lerpResult831 = lerp( _ShallowColor , _DeepColor , clampResult211);
				float3 bakedGI886 = ASEIndirectDiffuse( input, ase_normalWS );
				Light ase_mainLight = GetMainLight( ShadowCoords );
...
ASEEND*/
//CHKSM=E086FB7C83456B60985646CD0FD11F2D86708E3E